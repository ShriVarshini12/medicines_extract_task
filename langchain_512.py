...
# PGVector Store
vector_store_512 = PGVector(
    connection_string=CONNECTION_STRING,
    embedding_function=embeddings,
    collection_name="medicine_collection_512",
...
def store_product_embeddings():
    ...
    for idx, row in enumerate(rows, start=1):
        ...
        vector_store_512.add_documents([doc])   # Add one at a time
...
def check_availability(extracted_medicines, top_k=3):
    ...
    for med in extracted_medicines:
        ...
        docs_and_scores = vector_store_512.similarity_search_with_score(
            med,
            k=top_k
        )
